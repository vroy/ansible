    ...
    def run(self, iterator, play_context):
        ...
        while work_to_do and not self._tqm._terminated:
            ...
            try:
                ...
                hosts_left = [host for host in self._inventory.get_hosts(iterator._play.hosts) if host.name not in self._tqm._unreachable_hosts and host.name not in self._tqm._failed_hosts]
